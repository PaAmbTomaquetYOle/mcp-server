...
class TrelloLoginPromptController(BaseController):
    ...
    async def trello_login() -> str:
        return (
            ...
            "4. After authorizing, the user will receive an OAuth token and token_secret. "
            "Ask the user to provide both values.\n"
            "5. Call `complete_trello_auth` with the token and token_secret. "
